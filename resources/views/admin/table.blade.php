    ...
    <div class="wrapper">
        ...
        <h2><img src="{{ asset('img/esith-copy.png') }}" alt="Logo de esith"></h2>
            ...
            <ul>
                ...
                <li><a href="#"><i class="fas fa-envelope"></i>Commande reçue</a></li>
    ...
    <table border="1" id="myTable">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="color: {{ $data->impression_type === 'examen' ? 'red' : 'black' }}">{{ $data->impression_type }}</td>
                ...
                <td>{{ $data->pdf_path }}</td>
                <td>
                <a href="{{ url('/download/' . urlencode($data->pdf_path)) }}" download class="custom-button">
                ...
                <td>
                <button type="submit" onclick="validate({{ $data->id }})" class="custom-button">
    Valider
</button>
